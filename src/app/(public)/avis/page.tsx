            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <motion.div {...fadeUp(0)} className="text-center mb-16">
                    ...
                    <h1 className="text-6xl md:text-8xl font-serif text-stone-900 leading-[1.1]">
                        Avis <span className="italic font-light text-accent-dark/60">Clients</span>
                    </h1>
                </motion.div>

                {/* Inline Form */}
                <motion.div {...fadeUp(0.1)} className="mb-24 bg-stone-50 rounded-[2.5rem] p-12 border border-stone-100 shadow-sm relative overflow-hidden group">
                    {submitted ? (
                        <motion.div 
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                            <div>
                                <h3 className="text-3xl font-serif mb-4 text-stone-900">Votre <span className="italic text-accent-dark/80">Expérience</span></h3>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-accent-dark shadow-sm">
                                            <Star size={18} className="fill-accent-dark" />
                                        </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8 bg-white p-10 rounded-[2rem] shadow-xl shadow-stone-200/40 border border-stone-50">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full border-b border-stone-100 py-3 focus:border-accent-dark outline-none transition-colors font-serif text-lg text-stone-900"
                                        placeholder="Marie L."
                                    />
                                </div>
                                    ...
                                    <div className="flex gap-2 py-2">
                                        {[1,2,3,4,5].map(star => (
                                            ...
                                            >
                                                <Star 
                                                    size={24} 
                                                    className={star <= formData.rating ? "fill-accent-dark text-accent-dark" : "text-stone-100"} 
                                                />
                                            </button>
                                        ))}
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full border-none bg-stone-50 rounded-2xl p-4 focus:ring-1 focus:ring-accent-dark outline-none transition-all font-sans text-sm italic text-stone-600"
                                ...
                                <button 
                                    type="submit"
                                    className="w-full py-5 bg-stone-900 text-white rounded-2xl font-caps text-xs tracking-[0.3em] hover:bg-accent-dark transition-all shadow-lg hover:shadow-xl active:scale-[0.98]"
                                >
                                    ENVOYER MON AVIS
                                </button>
                            </form>
                ...
                {/* Divider / Title for list */}
                <div className="mb-12 flex items-center justify-between">
                    <div>
                        <h3 className="text-[10px] uppercase tracking-[0.4em] font-black text-stone-400 mb-1">Témoignages</h3>
                        ...
                        >
                            <div className="flex items-center gap-0.5 mb-5">
                                {[...Array(review.rating)].map((_, j) => (
                                    <Star key={j} size={12} className="fill-accent-dark text-accent-dark" />
                                ))}
                            </div>
                ...
                <motion.div {...fadeUp(0.6)} className="mt-24 text-center">
                    <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-stone-50 border border-stone-100">
                        ...
                        <span className="text-[9px] uppercase tracking-[0.2em] font-black text-stone-400">
