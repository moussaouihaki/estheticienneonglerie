        ...
        <footer className="py-20 px-6 bg-stone-950 text-white border-t border-stone-800">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <div className="flex flex-col items-center md:items-start gap-2">
                    <span className="font-serif text-3xl tracking-widest uppercase text-accent">Aurélia</span>
                ...
                <div className="flex flex-col items-center md:items-end gap-4">
                    ...
                    <div className="flex flex-col items-center md:items-end gap-2 text-xs font-light text-stone-500 tracking-wide">
                        <div>
                            © {currentYear} Aurélia Nail Studio. Conçu avec <Heart size={12} className="text-accent fill-accent inline mx-1 animate-pulse" /> à Paris.
                        </div>
                        <Link
                            href="/admin"
